...
svy: gsem (lonely_binary3 lonely_binary4 lonely_binary5 lonely_binary6 lonely_binary7 lonely_binary8 <- ), probit lclass(class `nclass') emopts(iterate(100)) listwise
...
save "X:/Paper 2. Loneliness LCA/Data/wide data - with weights_sens_prob.dta", replace


// load wide format data
use "X:/Paper 2. Loneliness LCA/Data/wide data - with weights_sens_prob.dta", clear
...
save "X:/Paper 2. Loneliness LCA/Data/long data - with weights_sens_prob.dta", replace
